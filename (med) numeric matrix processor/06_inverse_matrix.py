import numpy as np
# was totally over this project by this point so used numpy
...
while True:
    ...
    if choice == 0:
        ...
        inv_size = [int(a) for a in input('Enter size of matrix: ').split()]
        print('Enter matrix:')
        inv_matrix = get_matrix(inv_size)
        inverse = np.linalg.inv(inv_matrix) 
        print('The result is:')
